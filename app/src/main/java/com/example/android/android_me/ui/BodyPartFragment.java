...
public class BodyPartFragment extends Fragment {
    ...
    private static final String SAVE_IMAGELIST = "imageList";
    private static final String SAVE_LISTINDEX = "listIndex";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null){
            mImageIds = savedInstanceState.getIntegerArrayList(SAVE_IMAGELIST);
            mListIndex = savedInstanceState.getInt(SAVE_LISTINDEX);
        }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putIntegerArrayList(SAVE_IMAGELIST, (ArrayList<Integer>) mImageIds);
        outState.putInt(SAVE_LISTINDEX, mListIndex);
    }
}
